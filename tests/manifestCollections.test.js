...
const EXPECTED_SCHEMA_FIELDS = {
  ...
  [COLLECTIONS.selectedScopeMask]: [
    'id', 'run_id', 'generated_at', 'generation_mode', 'output_collection',
    'inclusion_key', 'active_flag',
    'period_type', 'period_label_current', 'period_label_prior',
    'comparison_side', 'comparable_week_slot',
    'store_code', 'store_name', 'region', 'metric',
    'week_ending', 'week_of_year', 'month_of_year', 'financial_year',
    'comparison_mode', 'comparison_window_id',
    'calendar_include_flag', 'calendar_reason_code',
    'trading_expectation_flag', 'trading_reason_code',
    'metric_coverage_flag', 'metric_reason_code',
    'source_value', 'source_row_count', 'source_data_exists',
    'paired_slot_reason_code',
    'system_include_flag', 'manual_include_flag', 'effective_include_flag',
    'paired_slot_include_flag', 'final_include_flag', 'mask_include_flag',
    'is_manual_override', 'manual_reason',
    'system_reason_code', 'final_reason_code',
    'store_trading_commencement_date', 'store_closure_date',
